...
#define PORTKB PORTC //Set PORTA, PORTB, PORTC or PORTD
#define DDRKB DDRC
#define PINKB PINC

#define KB_PRESET 1 //0 for manual, otherwise use a PRESET: 1 is proteus, 2 is 4x4 keyboard I had

#if KB_PRESET == 0
//Manual CONFIG
#define KB_READWRITEMODE 0 //Defines which half of port is input. 0: input is low bits
#define KB_READDIR 0 //Defines the direction of input pins; 0 is asc, 1 is desc
#define KB_WRITEDIR 0 //Defines the direction of output pins; 0 is asc, 1 is desc
#define KB_CODE_STR "123456789ABCDEFG" //Define the keyboard setup, 

#elif KB_PRESET == 1
#define KB_READWRITEMODE 1
#define KB_READDIR 0
#define KB_WRITEDIR 0
